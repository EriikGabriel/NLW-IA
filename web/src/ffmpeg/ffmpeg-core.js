var createFFmpegCore = (() => {
  ...
  return async function (createFFmpegCore = {}) {
    ...
    var _ffmpeg = (Module["_ffmpeg"] = function () {
      return (_ffmpeg = Module["_ffmpeg"] = Module["asm"]["xa"]).apply(
        null,
        arguments
      )
    })
    ...
    var _emscripten_builtin_memalign = function () {
      return (_emscripten_builtin_memalign = Module["asm"]["za"]).apply(
        null,
        arguments
      )
    }
    ...
    var _ff_h264_cabac_tables = (Module["_ff_h264_cabac_tables"] = 1529068)
    var ___start_em_js = (Module["___start_em_js"] = 6024597)
    var ___stop_em_js = (Module["___stop_em_js"] = 6024774)
